...
const Projectlist = () => {
    return (
        <div className="project-list">
            <Allproject img={rosewood} h3={"Rosewood — Bakery & Cake Shop"} p={"A premium, fully responsive bakery website template for bakeries, home bakers, cake studios, and dessert"} link={"https://rosewood-bakery-domo.vercel.app/"} />
