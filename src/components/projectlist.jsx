...
const Projectlist = () => {
    return (
        <div className="project-list">
            ...
            <Allproject img={chatbot} h3={"Weather Report Chat Bot"} p={"Developed a weather application with Chat Bot using JavaScript, HTML, CSS, and IBM Watson Assistant for real-time weather data fetching based on user input "} link={"https://pugaleeshwaran.github.io/Weather-Chat-bot-deployment-/"} />
        </div>
